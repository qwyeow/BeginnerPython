...
def areatriangle(b,h):
    area = 0.5*b*h
    print("The area of a triangle with base", b, "and height", end = "")
    print(h, "is", area)
...
def celsius_to_fahrenheit(temp):
    fah = 9/5*temp +32
    print("The Celsius tmeperature", temp, "is equivalent to", fah, "degrees Fahrenheit.")
...
def name():
    ...
    lname = input("Enter your last name: ")
    fullname = fname + " " + lname
    city_ = input("Enter the city you live in:")
    state_= input("Enter the state you live in:")
    add = city_ + ", " + state_
    print("Your name is:", fullname, end = " and ")
    print("your address is", add)
    print("Your name is:", fullname, " and your address is", add)
...
"""
def hours2second():
    hour = input("Key in the number of hours:")
    
    if hour:
        if hour.isdigit():
            hour1 = int(hour)
            seconds = hour1*60*60
            print(hour, "hour(s) is equivalent to", seconds, "seconds.")
#%%
def mins2hour():
    time = input("Key in the number of mins: ")
    if time:
        if time.isdigit():
            time = int(time)
            hour = time//60
            mins = time%60
            print(time, "is equvalent to", hour, "hours and ", mins, "minutes.")
        else:
