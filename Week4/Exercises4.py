...
lstr3 = ("A very long string can also be tied together using "
          "parentheses to enclose the various parts."
...
#  Note that sorted(numlist) is temporary while numlist.sort() is permanent 
#%%
""" 
...
# Note that Alphlist.sort() takes CAP F in front of small cap b
#%%
...
def temp_stat(temps):
    ...
    print("Variance:", statistics.variance(temperatures))
...
def temp_stat(temps):
    ...
    try:
        print("Mode:", statistics.mode(temperatures))
    except Exception as e:
        print("Mode error:", e)
