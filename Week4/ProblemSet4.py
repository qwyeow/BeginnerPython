...
def problem4_1(wordlist):
    ...
    print(wordlist)
    #wordlist.sort()  Big Cap ABC followed by small cap abc
    #print(wordlist)
    wordlist.sort(key=str.lower) # abc in order regardless of Big/small cap
    print(wordlist)
    #print(sorted(wordlist))  # temporary sorted Big cap ABC followed by small cap abc
